        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3 mt-1">
                                        ...
                                        <span class="text-sm text-gray-400">创建于 {{ task.created_at }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- 描述 -->
                    <div v-if="task.description" class="px-6 py-4 border-b border-gray-100">
                    ...
                    <div class="px-6 py-4 border-b border-gray-100">
                        ...
                        <dl class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <dd class="text-sm text-gray-900">{{ task.created_at }}</dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="px-6 py-4 border-b border-gray-100">
                        ...
                        <!-- 已指派 -->
                        <div v-if="task.agent" class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                        ...
                        <div v-else>
                            ...
                            <div v-if="showAssignForm" class="mt-2">
                                ...
                                <p v-if="availableAgents.length === 0" class="text-xs text-amber-600">
                                    ⚠️ 当前没有可用的 Agent（没有在线且有容量的 Agent）
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- 状态操作 -->
                    <div v-if="showStatusActions" class="px-6 py-4 border-b border-gray-100">
                        <div class="flex items-center space-x-3">
