    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-500">创建新账户</p>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                placeholder="至少 8 位"
                                :class="['w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 pr-10',
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="再次输入密码"
                            :class="['w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500',
                                form.errors.password_confirmation ? 'border-red-300 bg-red-50' : 'border-gray-300']"
                        />
